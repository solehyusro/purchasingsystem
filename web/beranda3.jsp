    ...
    <body>
        <div class="transbox">
            <div class="wrap">
                ...
                <div id="menu">
                    <ul>    
                        <li><a href="beranda3.jsp?hal=home"><img src="gambar/homee.png"/></a></li>
                        ...
                        <div class="post">
                            <div class="entry">
                                <c:choose>
                                    ...
                                    <c:when test="${param.hal=='laporan-pembelian'}">
                                         <%@include file="tampil_lap_pembelian.jsp" %>
                                    </c:when>
                        ...
                        <div class="post">
                            <ul>        
                                <li>
                                    ...
                                    <ul>
                                         <li><a href="beranda3.jsp?hal=laporan-barang">Laporan Data Bahan Baku</a></li>
                                        <li><a href="beranda3.jsp?hal=laporan-pembelian">Laporan Pembelian</a></li>
                                    </ul>
                                </li>
