...
<html>
    ...
    <body>
        ...
        <img src="gambar/brng.png" width="45px" height="45px" style="float:left; margin-right: 5px; margin-left: 20px;"/>
        <form action="barangServlet" method="POST">
            <table border="17" cellpadding="17">
                <tbody>
                     <tr style="background-color: white; color: black;">
                        <td>Kode Bahan Baku</td>
                        <td><input type="text" name="kode_barang" size="25" /></td>
                    </tr>
                    <tr>
                     ...
                     <tr style="background-color: white; color: black;">
                        <td>Harga Beli</td>
                        <td><input type="text" name="harga_beli" size="25"/> </td>
                    </tr>
                    <tr>
                        <td>Stok Bahan Baku</td>
                        <td><input type="text" name="stok_barang" size="25"/> </td>
                    </tr>
            <tr>
